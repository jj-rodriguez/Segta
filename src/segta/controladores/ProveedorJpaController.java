...
public class ProveedorJpaController implements Serializable {
    ...
    public void create(Proveedor proveedor) {
        ...
        try {
            ...
            Localidad idLocalidad = proveedor.getIdLocalidad();
            if (idLocalidad != null) {
                idLocalidad = em.getReference(idLocalidad.getClass(), idLocalidad.getIdLocalidad());
                proveedor.setIdLocalidad(idLocalidad);
            }
            em.persist(proveedor);
            if (idLocalidad != null) {
                idLocalidad.getProveedorCollection().add(proveedor);
    ...
    public void destroy(Integer id) throws NonexistentEntityException {
        ...
        try {
            ...
            Localidad idLocalidad = proveedor.getIdLocalidad();
            if (idLocalidad != null) {
                idLocalidad.getProveedorCollection().remove(proveedor);
                idLocalidad = em.merge(idLocalidad);
            }
            em.remove(proveedor);
            em.getTransaction().commit();
